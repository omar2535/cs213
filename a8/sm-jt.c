...
int exec() {
  static const void* jumpTable[]  = {&&L0,&&L1,&&L2,&&L3,&&L4,&&DEFAULT,&&L6,&&L7,&&L8,&&L9,&&LA,&&LB,&&LC,&&LD,&&LE,&&LF};
  static const void* jumpTable6[] = {&&L60,&&L61,&&L62,&&L63,&&L64,&&L65,&&L66,&&L67,&&DEFAULT6,&&DEFAULT6,&&DEFAULT6,&&DEFAULT6,&&DEFAULT6,&&DEFAULT6,&&DEFAULT6,&&L6F};
  int cont = 1;
  int addr, val;
